...
methods 
    ...
    function secmImage = back_project(obj,varargin)
    % secmImage = obj.BACK_PROJECT() Back project scurrents to image.
    ...
    % See also SECMIMAGE.LINE_PROJECT
        ...
        elseif strcmp( varargin{1}, 'array' )
            imgs = cell(1,1);
            imgs{1,1} = img; 
            secmImage = SecmImageArray(obj1.ticks,imgs);
        else 
