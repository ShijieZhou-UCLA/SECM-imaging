classdef IPalmSecmSimul < IPalm
    ...
    methods
        function obj = IPalmSecmSimul(problem,true_map,dict)
...
%            obj.vars{1}.draw_images;   %%% Shijie: display the separate sparse maps, please uncomment line 53 & 54 when using this.
            set(gca,'YDir','normal');
